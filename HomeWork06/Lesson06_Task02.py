...
# /Volumes/ARHIV/PYTHON/Algoritm_dannye/HomeWork/venv/bin/python /Volumes/ARHIV/PYTHON/Algoritm_dannye/HomeWork/HW06/Lesson06_Task02.py
# Введите трехзначное число: 3
# Cумма цифр = 3; Произведение цифр = 0
# ================================================================================
# Данные о переменных:
# 	 Имя переменной = ['a', 'd', 'sum_']; тип = <class 'int'>; размер = 28; содержимое =  3
# 	 Имя переменной = ['b', 'c', 'mul_']; тип = <class 'int'>; размер = 24; содержимое =  0
# 	 Имя переменной = ['b', 'c', 'mul_']; тип = <class 'int'>; размер = 24; содержимое =  0
# 	 Имя переменной = ['a', 'd', 'sum_']; тип = <class 'int'>; размер = 28; содержимое =  3
# 	 Имя переменной = ['a', 'd', 'sum_']; тип = <class 'int'>; размер = 28; содержимое =  3
# 	 Имя переменной = ['b', 'c', 'mul_']; тип = <class 'int'>; размер = 24; содержимое =  0
# ================================================================================
# Суммарный размер всех переменных из списка: 156